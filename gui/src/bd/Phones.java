...
public class Phones extends javax.swing.JFrame {
    ...
    public ArrayList<SetterPhones> tableList(){
        
        ArrayList<SetterPhones> tableList = new ArrayList<>();
        ...
        try{
            ...
            SetterPhones setter;
            while(rs.next()){
                setter = new SetterPhones(rs.getInt("ph_br_code"), rs.getString("ph_number"));
        ...
        ArrayList<SetterPhones> list = tableList();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ph_br_code");

        jLabel2.setText("ph_number");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String query = "INSERT INTO phones VALUES ("+jTextField1.getText()+",'"+jTextField2.getText()+"' );";
        executeQuery(query, "Inserted");
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String query = "UPDATE phones SET ph_number= '"+jTextField2.getText()+"' WHERE ph_number= '"+jTextField3.getText()+"' ;";
        executeQuery(query, "Updated");
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String query = "DELETE FROM phones WHERE ph_number= '"+jTextField2.getText()+"' ;";
